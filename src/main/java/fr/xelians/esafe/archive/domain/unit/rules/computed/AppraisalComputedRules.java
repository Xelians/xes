...
public class AppraisalComputedRules extends AbstractComputedRules implements FinalActionRule {

  @JsonProperty("FinalAction")
  protected List<String> finalActions = new ArrayList<>();

  public AppraisalComputedRules duplicate() {
    AppraisalComputedRules rules = new AppraisalComputedRules();

...
@ToString
public abstract class RegexOperator<T> extends TextualOperator<T> {

  // { "$eq": { "societe.facture": "client1" } , "$type": "Facture"  }
  protected RegexOperator(DslParser<T> parser, SearchContext searchContext, JsonNode parameter) {

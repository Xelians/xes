...
public final class RegisterSummarySpecialFields {
  ...
  private RegisterSummarySpecialFields() {}

  private static Map<String, String> createBaseFields() {
    return Map.ofEntries(
        Map.entry("#id", "_summaryId"), Map.entry("#version", "_v"), Map.entry("#score", "_score"));
  }
